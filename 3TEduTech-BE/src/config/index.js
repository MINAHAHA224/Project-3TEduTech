...
const envVarsSchema = Joi.object()
  .keys({
    ...
    DB_HOST: Joi.string().required().description('DESKTOP-D4BGI46'),
    DB_PORT: Joi.number().default(1433).description('1433'),
    DB_USER: Joi.string().required().description('sa'),
    DB_PASSWORD: Joi.string().required().description('123456'),
    DB_NAME: Joi.string().required().description('ThreeTEduTechLMS'),
